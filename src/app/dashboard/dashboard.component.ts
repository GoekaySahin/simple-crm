...
export class DashboardComponent {
  ...
  /**
   * This function check the screen size
   *
   * @param event If screen size gets chanced
   */
  ...
  /**
   * This function will define the line width and height
   */
  lineWidth() {
  ...
  /**
   * This function will set the pagename
   */
  setDashboardToShow() {
